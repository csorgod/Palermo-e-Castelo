<?php 
	...
	//Language menu.php
	$lang['menu_navbar_office'] = 'O ESCRITÓRIO';
	$lang['menu_navbar_office_history'] = 'HISTÓRICO';
	$lang['menu_navbar_office_aboutus'] = 'QUEM SOMOS';
	$lang['menu_navbar_office_mission'] = 'MISSÃO';
	$lang['menu_navbar_lawyer'] = 'ADVOGADOS';
	$lang['menu_navbar_actuation'] = 'ÁREAS DE ATUAÇÃO';
	$lang['menu_navbar_publication'] = 'PUBLICAÇÕES E EVENTOS';
	$lang['menu_navbar_contact'] = 'CONTATO';
	//End Language menu.php

	//Language index.php

	//Pre Loader and Modals
	$lang['index_preload_text'] = 'Carregando';
	$lang['index_modal_modalsuccess1_title'] = 'Sucesso!';
	$lang['index_modal_modalsuccess1_body'] = 'Recebemos sua solicitação. Em breve, entraremos em contato.';
	$lang['index_modal_modalsuccess1_footer_button_close'] = 'Fechar';
	$lang['index_modal_modalsuccess2_title'] = 'Sucesso!';
	$lang['index_modal_modalsuccess2_body'] = 'Você foi cadastrado em nossa newsletter Em breve, você receberá nossos e-mails.';
	$lang['index_modal_modalsuccess2_footer_button_close'] = 'Fechar';
	$lang['index_modal_modalError1_title'] = 'Atenção:';
	$lang['index_modal_modalError1_body'] = 'Algo deu errado no envio. Se preferir, encaminhe um e-mail para <a href="mailto:contato@palermoecastelo.com.br" style="color: blue;">contato@palermoecastelo.com.br';
	$lang['index_modal_modalError1_footer_button_close'] = 'Fechar';
	$lang['index_modal_modalError2_title'] = 'Atenção:';
	$lang['index_modal_modalError2_body'] = 'Não conseguimos te cadastrar na nossa newsletter. Por favor, encaminhe um e-mail para <a href="mailto:contato@palermoecastelo.com.br" style="color: blue;">contato@palermoecastelo.com.br</a>';
	...
	//title CONTATO
	$lang['index_title_contact'] = 'CONTATO';

	//End Language index.php


	//Language menu-contato.php
	//left
	...
	//right
	$lang['menucontato_right_form_placeholder_name'] = 'NOME';
	$lang['menucontato_right_form_placeholder_tel'] = 'TELEFONE';
	$lang['menucontato_right_form_placeholder_email'] = 'E-MAIL';
	$lang['menucontato_right_form_placeholder_subject'] = 'ASSUNTO';
	$lang['menucontato_right_form_placeholder_file_title'] = 'ANEXAR ARQUIVO';
	$lang['menucontato_right_form_placeholder_file_button'] = 'PROCURAR';
	$lang['menucontato_right_form_placeholder_message'] = 'MENSAGEM';
	$lang['menucontato_right_form_placeholder_submit_button'] = 'ENVIAR';
	...
	*/
	...
	$lang['escritorio_mission_text6'] = '-Pioneirismo e Inovação';
	//End Language escritorio.php

	//Language footer-contact.php
	$lang['footercontact_footertext_followus'] = 'Siga-nos:';
	//End Language footer-contact.php

	//Language advogados.php
	$lang['label'] = 'value';
	
	//End Language advogados.php

	//Language Atuação.php
	$lang['atuacao_administrator'] = 'Administrativo';
	$lang['atuacao_customer'] = 'Direito do Consumidor';
	$lang['atuacao_societary'] = 'Societário';
	$lang['atuacao_environmental'] = 'Ambiental';
	$lang['atuacao_international'] = 'Direito Internacional';
	$lang['atuacao_labor'] = 'Trabalhista';
	$lang['atuacao_commercial'] = 'Comercial';
	$lang['atuacao_realstate'] = 'Imobiliária';
	$lang['atuacao_tax'] = 'Tributário';
	$lang['atuacao_contractual'] = 'Contratual';
	$lang['atuacao_social_security'] = 'Previdenciario';
	$lang['atuacao_civil'] = 'Cível';
	$lang['atuacao_intellectual_property'] = 'Propriedade Intelectual';

	//End Language Atuação.php
 
	//Language publicacoeseventos.php
	$lang['publicacoeseventos_title_filter'] = 'FILTROS';
	$lang['publicacoeseventos_filter_content'] = 'POR CONTEÚDO';
	$lang['publicacoeseventos_filter_lawyer'] = 'POR ADVOGADO';
	$lang['publicacoeseventos_filter_actuation'] = 'ÁREAS DE ATUAÇÃO';
	$lang['publicacoeseventos_filter_type'] = 'TIPO';
	$lang['publicacoeseventos_filter_year'] = 'ANO';
	$lang['publicacoeseventos_filter_month'] = 'MÊS';
	$lang['publicacoeseventos_button_send'] = 'ENVIAR';

	$lang['publicacoeseventos_title_publications'] = 'Publicações';
	//End Language publicacoeseventos.php

	//Language /atuacao-content/
